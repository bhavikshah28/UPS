...
namespace 
{
  ...
  partial class ThisAssembly
  {
    ...
    public partial class Git
    {
      ...
      /// <summary>Repository URL: https://github.com/asadsahi/AspNetCoreSpa</summary>
      public const string RepositoryUrl = @"https://github.com/asadsahi/AspNetCoreSpa";

      /// <summary>Branch: master</summary>
      public const string Branch = @"master";

      /// <summary>Commit: 64ce2af</summary>
      public const string Commit = @"64ce2af";

      /// <summary>Sha: 64ce2afc76b19b7d143262fcb28edc6d69bdd4a3</summary>
      public const string Sha = @"64ce2afc76b19b7d143262fcb28edc6d69bdd4a3";

      /// <summary>Commit date: 2023-03-02T11:12:34+00:00</summary>
      public const string CommitDate = @"2023-03-02T11:12:34+00:00";

      /// <summary>Commits on top of base version: 391</summary>
      public const string Commits = @"391";

      /// <summary>Tag: 0.1-391-g64ce2af</summary>
      public const string Tag = @"0.1-391-g64ce2af";

      /// <summary>Base tag: 0.1</summary>
      public const string BaseTag = @"0.1";
      ...
      public partial class SemVer
      {
        ...
        /// <summary>Patch: 391</summary>
        public const string Patch = @"391";
